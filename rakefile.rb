...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.WebForms"
COPYRIGHT = 'Copyright 2012 Jeremy D. Miller, Chad Myers, Joshua Flanagan. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.WebForms.sln', :clrversion => CLR_TOOLS_VERSION
